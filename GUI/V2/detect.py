...
class YOLO():
    ...
    def __init__(self, weights):
        ...
        parser.add_argument('--name', default='inference/output', help='save results to project/name')
    ...
    def Detect(self, source):
        ...
        self.opt.source = source #update source

        self.run(**vars(self.opt))
                
                

    def run(self, weights,  # model.pt path(s)
        ...
        name=ROOT / 'inference/output',  # save results to project/name
...
# yl = YOLO(weights='weights/Polyp_light.pt')
