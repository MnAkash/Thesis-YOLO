...
Created on Sun Dec  13 00:28:47 2021
@author: akash
"""
...
def mask2bbox(main_image, mask_image, show_bbox=False, show_contour=False):
    ...
    # Load the mask image
    #mask image is RGB 3 channel image, first converted to single channel greyscale imag
    im = cv2.imread(mask_image)
...
images = glob.glob("Abnormal/*.jpg")
masks = glob.glob("Abnormal_Annotation/*.bmp")
